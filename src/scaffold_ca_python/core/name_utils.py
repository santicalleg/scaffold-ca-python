...
def validate_name(name: str) -> str:
    ...
    if not _NAME_RE.match(name):
        raise ScaffoldError(
            ...
            "Hint: names must start with a letter and contain only letters, digits, and underscores."
        )
    return name


def to_snake_case(name: str) -> str:
    """Convert *name* (PascalCase, camelCase, or already snake_case) to snake_case."""
